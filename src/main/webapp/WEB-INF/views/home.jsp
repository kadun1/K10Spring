...
<div class="container">
	...
	<!-- 
		...
		매핑하였기 때문에 매핑명ㅇ르 통해 경로를 지정할 수 있다.
	 -->
	...
	<li>
		<a href="./form/requestParam.do?id=kosmo&pw=1234&name=홍길동&email=hong@gildon.com" target="_blank">
			@requestParam 어노테이션으로 폼값받기
		</a>
	</li>
	
		<li>
		<a href="./form/commandObject.do?id=kosmo&pw=1234&name=홍길동&email=hong@gildon.com" target="_blank">
			커맨드(Command) 객체로 한번에 폼값받기
		</a>
	</li>
	<li>
		<a href="./form/gildon99/코스모" target="_blank">
